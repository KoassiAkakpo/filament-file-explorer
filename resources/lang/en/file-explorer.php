...
return [
    ...
    'trash' => [
        ...
        'restored' => 'Restored',
        'purged' => '{1} :count item deleted permanently|[2,*] :count items deleted permanently',
        ...
        'origin' => 'Was in',
        'deleted_at' => 'Removed',
        'count' => '{0} empty|{1} :count item|[2,*] :count items',
    ],
    'confirm' => [
        ...
        'trash_title' => '{1} Move this item to the trash?|[2,*] Move these :count items to the trash?',
        'trash_body' => 'You can restore it from the trash.',
        'trash' => 'Move to trash',
        'purge_title' => '{1} Delete this item permanently?|[2,*] Delete these :count items permanently?',
        'purge_body' => 'This cannot be undone.',
        'purge' => 'Delete permanently',
        'cancel' => 'Cancel',
        'delete' => 'Delete',
    ],
