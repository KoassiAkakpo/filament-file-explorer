...
return [
    ...
    'trash' => [
        ...
        'restored' => 'Restauré',
        'purged' => '{1} :count élément supprimé définitivement|[2,*] :count éléments supprimés définitivement',
        ...
        'count' => '{0} vide|{1} :count élément|[2,*] :count éléments',
    ],
    'confirm' => [
        ...
        'trash_title' => '{1} Mettre cet élément à la corbeille ?|[2,*] Mettre ces :count éléments à la corbeille ?',
        'trash_body' => 'Vous pourrez le restaurer depuis la corbeille.',
        'trash' => 'Mettre à la corbeille',
        'purge_title' => '{1} Supprimer définitivement cet élément ?|[2,*] Supprimer définitivement ces :count éléments ?',
        'purge_body' => 'Cette action est irréversible.',
        'purge' => 'Supprimer définitivement',
        'cancel' => 'Annuler',
        'delete' => 'Supprimer',
    ],
