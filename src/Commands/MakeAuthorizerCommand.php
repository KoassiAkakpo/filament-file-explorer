...
use Koassi\FilamentFileExplorer\Commands\Concerns\CopiesPackageStubs;
...
class MakeAuthorizerCommand extends Command
{
    ...
    public function handle(): int
    {
        ...
        $this->line("  \$this->app->singleton(\\Koassi\\FilamentFileExplorer\\Contracts\\FileExplorerAuthorizer::class, \\{$namespace}\\{$name}::class);");
        $this->newLine();
